 ...
 * @author Markus, Simon
 */
public class AdminClient implements SitInPartyConnection {
     ...
     */
    @Override
    public boolean veranstaltungHinzufuegen(String beschreibung, Integer maxTeilnehmerzahl, String ort, String name, Date startTermin, Benutzer veranstalter) throws RemoteException {
        return this.server.veranstaltungHinzufuegen(beschreibung, maxTeilnehmerzahl, ort, name, startTermin, veranstalter);
    }
